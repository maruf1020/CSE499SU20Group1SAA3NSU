                ...
                <div class="card card-custom">
                    ...
                    <div class="card-header py-3">
                        <div class="card-title align-items-start flex-column">
                            ...
                            <span
                                class="text-muted font-weight-bold font-size-sm mt-1">Update your personal informaiton</span>
                        </div>
                        <div class="card-toolbar">
                            <!--begin::Form-->
                            @foreach ($user as $key => $value)
                                <form class="form"
                                      action="{{ route('personal-infomation.update',$value->personal_info->id) }}"
                                      method="POST">
                                    @csrf
                                    @method('PUT')
                        ...
                        <div class="flex-row-fluid">
                            ...
                            <div class="card card-custom card-stretch">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-xl-3 col-lg-3 col-form-label text-right">Change
                                            Password</label>
                                        <div class="col-lg-9 col-xl-6">
                                            <div class="input-group input-group-lg ">

                                                <a href="admin-change-password"
                                                   class="btn btn-danger btn-shadow-hover font-weight-bold mr-2">Change
                                                    Password</a></div>
                                        </div>
