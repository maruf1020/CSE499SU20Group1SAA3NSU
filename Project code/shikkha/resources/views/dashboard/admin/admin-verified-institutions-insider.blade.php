			...
			<div class="card card-custom">
				...
				<div class="card-header py-3">
								...
								<div class="card-toolbar">
									<form class="" action="{{ route('verify-institution.update',$verify_institution->id) }}" method="post">
										@csrf
										@method('PUT')
								...
								<div class="card-body">
									<div class="row">
										...
										<div class="col-lg-9 col-xl-6">
											<h5 class="font-weight-bold mb-6">University Info</h5>
										</div>
									</div>
									<div class="form-group row">
										...
										<div class="col-lg-9 col-xl-6">
											...
											<div class="form-group row">
												<label class="col-xl-3 col-lg-3 col-form-label text-right">University Name</label>
												<div class="col-lg-9 col-xl-6">
													<input
														class="form-control form-control-lg form-control-solid"
														type="text"
														value="{{ $verify_institution->institution->name }}" disabled></div>

												</div>
												<div class="form-group row">
													<label class="col-xl-3 col-lg-3 col-form-label text-right">EIN Number</label>
													<div class="col-lg-9 col-xl-6">
														<input
															class="form-control form-control-lg form-control-solid"
															type="text"
															value="{{ $verify_institution->institution->ein }} " disabled></div>
													</div>
													<div class="form-group row">
														<label class="col-xl-3 col-lg-3 col-form-label text-right">Establish Date</label>
														<div class="col-lg-9 col-xl-6">
															<input
																class="form-control form-control-lg form-control-solid"
																type="1992"
																...
																<span class="form-text text-muted">If you want your invoices addressed to a
																	date. Leave blank to use without it.</span>
															</div>
														</div>
														<div class="row">
															<label class="col-xl-3"></label>
															...
															<div class="col-lg-9 col-xl-6">
																<div class="input-group input-group-lg input-group-solid">
																	...
																	<input
																		type="text"
																		class="form-control form-control-lg form-control-solid"
																		value="{{ $verify_institution->phone }}"
																...
																<div class="col-lg-9 col-xl-6">
																	<div class="input-group input-group-lg input-group-solid">
																		...
																		<input
																			type="text"
																			class="form-control form-control-lg form-control-solid"
																			value="{{ $verify_institution->email }}"
																	...
																	<div class="col-lg-9 col-xl-6">
																		<div class="input-group input-group-lg input-group-solid">
																			<input
																				...
																				value="{{ $verify_institution->website }}" disabled>
