									...
									<div class="modal-content">
										...
										<div class="modal-body">
											...
											<div class="form-group">
												...
												<input type="date" class="form-control form-control-lg" placeholder="Write Institution EIN Number" name="ein">
											</div>
											<div class="form-group">
												<label>Meeting time</label>
												<input type="time" class="form-control form-control-lg" placeholder="Write Institution EIN Number" name="time">
											</div>
											...
											<tr>
												...
												<td>
													...
													<p>
														...
														<a href="javascript:void(0)" data-url="" class="btn btn-icon btn-light-primary btn-sm mr-2 delete">
