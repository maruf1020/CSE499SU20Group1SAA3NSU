			...
			<div class="card card-custom">
				...
				<div class="card-header py-3">
					<div class="card-title align-items-start flex-column">
						<h3 class="card-label font-weight-bolder text-dark">Previous semester session Information</h3>
					...
					<div class="card-toolbar">
						...
						<!--begin::Button-->
						<a href="{{ url()->previous() }}" class="btn btn-primary font-weight-bolder mr-2">
