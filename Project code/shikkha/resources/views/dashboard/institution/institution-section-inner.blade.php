			...
			<div class="card card-custom">
				...
				<div class="card-header py-3">
					<div class="card-title align-items-start flex-column">
						...
						<span class="text-muted font-weight-bold font-size-sm mt-1">Section and there information</span>
					</div>
									...
									<form class="" action="{{ route('section.store') }}" method="post">
										<div class="modal-body">
											...
											<div class="form-group" style="visibility: hidden;position: absolute;">
												...
												<input name="section_number" type="number" class="form-control form-control-lg" placeholder="Write Section Number">
                                            </div>
                                                <div class="form-group">
                                                    ...
                                                    <select id="" class="form-control form-control-lg" name="faculty_id">
											...
											<div class="form-group">
												...
												<input name="capacity" type="number" class="form-control form-control-lg" placeholder="Write Section Capacity ">
                                            </div>
								...
								<div class="modal-content">
									...
									<form id="update-form" action="" method="post">
										...
										<div class="modal-body">
											...
											<div class="form-group">
												<input style="visibility: hidden;position: absolute;" id="id" name="id" type="hidden" class="form-control form-control-lg" placeholder="Write Faculty Name" value=''>
											</div>


                                                <div class="form-group" style="visibility: hidden;position: absolute;">
                                                    <input id="course_id" name="course_id" type="number" class="form-control form-control-lg" value="{{ $course->id }}" >
                                                </div>
                                                <div class="form-group">
                                                    <label>Section Number</label>
                                                    <input id="section_number" name="section_number" type="number" class="form-control form-control-lg" placeholder="Write Section Number">
                                                </div>
                                                <div class="form-group">
                                                    <label>Choose Session</label>
                                                    <select id="session" class="form-control form-control-lg" name="session">
                                                        <option value="">Select session</option>
                                                        @foreach ($session as $key=>$value)
                                                            <option value="{{ $value->id }}">{{ $value->name }}</option>
                                                        @endforeach
                                                ...
                                                <div class="form-group">
                                                    <label>Choose Faculty</label>
                                                    <select id="faculty" class="form-control form-control-lg" name="faculty_id">
                                                        <option value="">Select Faculty</option>
                                                        @foreach ($faculties as $key=>$value)
                                                            <option value="{{ $value->id }}">{{ $value->name }}</option>
                                                        @endforeach
                                                ...
                                                <div class="form-group">
                                                    <label>Choose Student</label>
                                                    <select id="student_id" class="form-control form-control-lg" name="student_id">
                                                        <option value="">Select Student</option>
                                                        <option value="2">EEE Department</option>
                                                ...
                                                <div class="form-group">
                                                    <label>Choose Start Time</label>
                                                    <select id="start" class="form-control form-control-lg" name="start">
                                                        <option value="">Select Start Time</option>
                                                        @foreach ($timings as $key=>$value)
                                                            <option value="{{ $value->start }}">{{ $value->start }}</option>
                                                        @endforeach
                                                ...
                                                <div class="form-group">
                                                    <label>Capacity </label>
                                                    <input id="capacity" name="capacity" type="number" class="form-control form-control-lg" placeholder="Write Section Capacity ">
                                                </div>
										</div>
