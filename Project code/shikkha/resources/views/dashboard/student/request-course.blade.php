        ...
        <div class="card card-custom">
            ...
            <div class="card-header flex-wrap border-0 pt-6 pb-0">
                <div class="card-title justify-content-between ">
                    <h3 class="card-label">Send Request
                        <span class="d-block text-muted pt-2 font-size-sm">You can send Course request here</span>
                    </h3>
                </div>
            ...
            <div class="card-body">
                <div class="d-flex flex-column flex-grow-1">
                    <div class="input-group input-group-solid col-xl-4 col-lg-6 col-md-6 col-sm-6">
                        ...
                        <input type="text" class="form-control py-4 h-auto" placeholder="Friends code"></div>
                        <div class="d-flex justify-content-between stream-button ml-40">
                            <a href="#" class="btn btn-success font-weight-bold">Send Request</a>
                        </div>
                    </div>
                </div>
                <!-- Content::stard -->
