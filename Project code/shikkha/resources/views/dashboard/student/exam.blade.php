		...
		<div class="container">
			...
			<div class="card card-custom">
				...
				<div class="card-header flex-wrap border-0 pt-6 pb-0">
					...
					<div class="card-title justify-content-between ">
					<a href="exam" class="btn btn-sm btn-success font-weight-bolder text-uppercase mr-3">Submit</a>
					</div>
								...
								<div class="card-body pt-4">
									...
									<div class="form-group mb-10">
										...
										<div class="checkbox-list">
											...
											<input id="closeButton" type="checkbox" value="checked">I think pie + 0.2584
											<span></span></label>
											<label class="checkbox">
											<input id="addBehaviorOnToastClick" type="checkbox" value="checked">It's must be 4
											<span></span></label>
											<label class="checkbox">
									...
									<div class="form-group kt-form__grou col-lg-2 mb-10">																		
										<input id="showDuration" type="text" class="form-control" placeholder="your ans">
										<!-- value="300" -->
									</div>
									<!-- Start::write short ans -->
									...
									<!--end::Choose file-->
									<label> <b>9.</b> Write a paragraph with hand written then take a photo and upload it here (700 words)</label><br>	
										<input type="file">
									<div class="mb-10"></div>	
									<!--START:Choose file
