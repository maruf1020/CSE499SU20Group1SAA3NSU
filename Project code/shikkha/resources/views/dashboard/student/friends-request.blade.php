				...
				<div class="card-header flex-wrap border-0 pt-6 pb-0">
					<div class="card-title justify-content-between ">
						<h3 class="card-label">Your Friends
							<span class="d-block text-muted pt-2 font-size-sm">All Your Friends shown here</span></h3>
					</div>
												...
												<div class="col-xl-4 col-lg-6 col-md-6 col-sm-6">
													...
													<div class="card card-custom gutter-b card-stretch">
														...
														<div class="card-body pt-4">
															<!--begin::Toolbar-->
															<a href="#" class="btn btn-success font-weight-bold mr-2">Accept</a>
                         									  	 <a href="#" class="btn btn-danger font-weight-bold mr-2">Decline</a>
																	...
																	<div class="dropdown-menu dropdown-menu-md dropdown-menu-right">
																		...
																		<ul class="navi navi-hover">
																			<li class="navi-header font-weight-bold py-4">
																				<span class="font-size-lg">No options available right now</span>
															...
															<div class="d-flex align-items-end mb-7">
																...
																<div class="d-flex align-items-center">
																	...
																	<div class="d-flex flex-column">
																		<a href="#" class="text-dark font-weight-bold text-hover-primary font-size-h4 mb-0">Maruf Billah</a>
