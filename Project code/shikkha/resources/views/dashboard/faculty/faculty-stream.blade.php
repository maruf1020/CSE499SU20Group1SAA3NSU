                ...
                <div class="card card-custom">
                    <div class="card-header">
                        ...
                        <div class="card-footer d-flex justify-content-between stream-button">
                            ...
                            <a href="{{ route('faculty-stream.show',$value->id) }}" class="btn btn-info font-weight-bold mr-2">stream</a>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="timeline timeline-5 mt-3">
													...
													<div class="timeline-item align-items-start">
														<!--begin::Label-->
														<div class="timeline-label font-weight-bolder text-dark-75 font-size-lg text-right pr-3">{{ $value1 }}</div>
														<!--end::Label-->
														<!--begin::Badge-->
