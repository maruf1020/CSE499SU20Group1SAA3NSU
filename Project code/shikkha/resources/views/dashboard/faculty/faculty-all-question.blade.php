			...
			<div class="card card-custom">
				...
				<div class="card-header py-3">
					<div class="card-title align-items-start flex-column">
						<h3 class="card-label font-weight-bolder text-dark">Question Information</h3>
						<span class="text-muted font-weight-bold font-size-sm mt-1">Question and there information</span>
					</div>
					<div class="card-toolbar">
						...
						<!--begin::Button-->
						<a href="{{ route('create-exam.create') }}" class="btn btn-success font-weight-bolder mr-2" >
							...
							<div class="modal-dialog modal-dialog-centered" role="document">
								<div class="modal-content">
									<div class="modal-header">
										<h5 class="modal-title" id="exampleModalLabel">Add New create-exam</h5>
										<button type="button" class="close" data-dismiss="modal" aria-label="Close">
											<i aria-hidden="true" class="ki ki-close"></i>
										</button>
									</div>
									<form class="" action="{{ route('create-exam.store') }}" method="post">
										<div class="modal-body">
											...
											<div class="form-group">
												...
												<input name="name" type="text" class="form-control form-control-lg" placeholder="Write create-exam Name"></div>
											<div class="form-group">
											...
											<div class="form-group">
												<label>create-exam Initial</label>
												<input name="initial" type="text" class="form-control form-control-lg" placeholder="Write create-exam Initial">
											</div>
											<div class="form-group">
												<label>Address</label>
						...
						<div class="modal fade" id="edit" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
							<div class="modal-dialog modal-dialog-centered" role="document">
								<div class="modal-content">
									<div class="modal-header">
										<h5 class="modal-title" id="exampleModalLabel">Update create-exam</h5>
									...
									<form id="update-form" action="" method="post">
										...
										<div class="modal-body">
											...
											<div class="form-group">
												<input id="id" name="id" type="hidden" class="form-control form-control-lg" placeholder="Write create-exam Name" value=''>
											</div>
											<div class="form-group">
												<label>create-exam name</label>
												<input id="name" name="name" type="text" class="form-control form-control-lg" placeholder="Write create-exam Name" value=''>
											</div>
											<div class="form-group">
												<label>Phone Number</label>
											...
											<div class="form-group">
												<label>create-exam Initial</label>
												<input id="initial" name="initial" type="text" class="form-control form-control-lg" placeholder="Write create-exam Initial">
											</div>
											<div class="form-group">
												<label>Address</label>
						...
						<div class="modal fade" id="view" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
							<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
								<div class="modal-content">
									<div class="modal-header">
										<h5 class="modal-title" id="exampleModalLabel">create-exam Information</h5>
										<button type="button" class="close" data-dismiss="modal" aria-label="Close" id='close'>
											<i aria-hidden="true" class="ki ki-close"></i>
										</button>
									</div>
																		...
																		<div class="card-body">
																			<div class="row">
																				...
																				<div class="col-lg-9 col-xl-6">
																					<h5 class="font-weight-bold mb-6">create-exam Info</h5>
																				</div>
																			</div>
																			<div class="form-group row">
																				...
																				<div class="col-lg-9 col-xl-6">
																					...
																					<div class="form-group row">
																						<label class="col-xl-3 col-lg-3 col-form-label text-right">create-exam Name</label>
																						<div class="col-lg-9 col-xl-6">
																							<input id="name1"
											...
											<tbody>
												...
												<tr class='value{{ $value->id }}'>
													...
													<td>
														...
														<a href="javascript:void(0)" data-method="DELETE" data-token="{{csrf_token()}}"  data-url="{{ route('create-exam.destroy',$value->id) }}" data-id="{{ $value->id }}" class="btn btn-sm btn-clean btn-icon delete" title="Delete">
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$(document).on('click', '.edit', function() {
				...
				// $('#update-form').attr('action',"/create-exam/"+id);
			});
		...
		$('#update-form').on('submit', function(event) {
			...
			$.ajax({
				...
				success: function(data) {
					...
					Swal.fire({
						title: "Success!",
						text: "create-exam Updated Succesfully!",
						icon: "success",
